...
- Graphite friction on the paper
- Paper rustle at encounter
- Low drone as space opens
- Metallic tension only as the helmet separates
- Air inside the nave
- Silence as a feature

No trailer hits. No looping “ambient music bed.”
...
1. Cowl — helmet, portal, the only world in this slice
2. Plates — structure, response without entry
3. Forward node — threshold, response without entry
...
Invisible scale from original artifact (0%) toward world (75%+) and back.

Encounter begins around 3–10%. Return is part of the artwork.
...
Preserve, in order: source artwork, composition, interaction, transformation continuity, sound, light, material, secondary effects, particles, post-processing.
